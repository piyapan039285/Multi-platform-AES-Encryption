...
## Encryption Input
have 2 parameters
* plain text string (string MUST be able to convert into UTF-8 encoding).
...
** Important ** : If you want to run unit test, you have to download "unlimited strength file". Then, install file to ${java.home}/jre/lib/security/. In Android Studio, you can find JDK path from Files -> Project Structure -> SDK Location.
